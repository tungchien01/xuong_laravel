...
(function ($) {
    ...
    //     }
    // );
    // $(".shop__sidebar__size_color label, .product__details__option__size_color label").on(
    //     "click",
    //     function () {
     ...
     * Variant
     */
    $(".product__details__size label").on("click", function () {
        $(".product__details__size label").on("click", function () {
            $(".product__details__size label").removeClass("active");
            $(this).addClass("active");
        });
    });
    $(".product__details__color label").on("click", function () {
        $(".product__details__color label").on("click", function () {
            $(".product__details__color label").removeClass("active");
            $(this).addClass("active");
        });
    });
