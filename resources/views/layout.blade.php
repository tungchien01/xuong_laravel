...
<head>
    ...
    <title>Techchain | @yield('title')</title>
...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="offcanvas__nav__option">
            <a href="#" class="search-switch"><img src="{{ asset('/asset/') }}/img/icon/search.png"
                    alt=""></a>
                ...
                <div class="col-lg-3 col-md-3">
                    <div class="header__nav__option">
                        <a href="#" class="search-switch"><img src="{{ asset('/asset/') }}/img/icon/search.png"
                                alt=""></a>
                        <a href="#"><img src="{{ asset('/asset/') }}/img/icon/heart.png" alt=""></a>
                        <a href="#"><img src="{{ asset('/asset/') }}/img/icon/cart.png" alt="">
                            <span>0</span></a>
                        <div class="price">$0.00</div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        <div class="footer__logo">
                            <a href="#"><img src="{{ asset('/asset/') }}/img/footer-logo.png"
                                    alt=""></a>
                        </div>
                        <p>The customer is at the heart of our unique business model, which includes design.</p>
                        <a href="#"><img src="{{ asset('/asset/') }}/img/payment.png" alt=""></a>
                    </div>
                </div>
